...
export class Sim {
  ...
  private decide(f: Fish): void {
    ...
    // collapsing onto one exact row. Derived from the id so each
    // fish holds a stable offset — re-rolling per decide would
    // flicker and couple the RNG stream to the population.
